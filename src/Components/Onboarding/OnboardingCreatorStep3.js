...
const OnboardingCreatorStep3 = ({ onNavigate }) => {
  ...
  return (
    <div className="onboarding-creator-step3">
      {/* Property Form Modal */}
      {showPropertyForm && (
      ...
      <div className="main-content">
          ...
          <div className="content-section">
            ...
            <div className="description-section">
              <div className="description">
                <span className="description-normal">As a creator, you would be able to </span>
                <span className="description-bold">list properties</span>
                <span className="description-normal"> and assign them to trainers.</span>
              </div>
            </div>
          </div>
        </div>
        <div className="right-content">
          <div className="step-container">
            ...
            <div className="property-card" onClick={handleAddNewPropertyClick}>
